...
Please identify the 18 types of named entities: "date", "organization", "person", "geographical social political", "national religious political", "facility", "cardinal", "location", "work of art", "law", "event", "product", "ordinal", "percent", "time", "quantity", "money", and "language", following the JSON template listed above, and output the JSON object. If no named entities identified, output {"named entities": []}.
...
Given the input text, evaluate each candidate token along with the surrounding tokens to determine if it should be categorized as (part of) one of the 18 named entity types: "date", "organization", "person", "geographical social political", "national religious political", "facility", "cardinal", "location", "work of art", "law", "event", "product", "ordinal", "percent", "time", "quantity", "money", and "language". **Use provided examples, if available, for reference.** If it should be a new entity, extract the exact text span in the sentence, including any spaces, in JSON format. Ensure tokens are not split (e.g., maintain hyphenated words intact). Note that abbreviations and full names are separate entities. If no changes are made, return {"named entities": []}.
...
1. Evaluate each candidate token listed above to determine if it should be categorized as (part of) one of the 18 named entity types: "date", "organization", "person", "geographical social political", "national religious political", "facility", "cardinal", "location", "work of art", "law", "event", "product", "ordinal", "percent", "time", "quantity", "money", and "language". Consider both the positive and negative examples provided carefully. Pay particular attention to the overall statistical data on whether tokens are included or excluded from the entity. Hard negative examples highlight tokens that are not part of the entity but are located near it.
