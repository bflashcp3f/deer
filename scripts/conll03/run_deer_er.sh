...
# bash scripts/conll03/run_deer_er.sh 8 deer openai text-embedding-3-small togetherai Qwen/Qwen2.5-7B-Instruct-Turbo 64 1.0 1.0 0.01 1 0.95 0.95 0.95
# bash scripts/conll03/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-mini-2024-07-18 64 1.0 1.0 0.01 1 0.5 0.5 0.9
# bash scripts/conll03/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-2024-08-06 64 1.0 1.0 0.01 1 0.95 0.95 0.95
...
# Step 2: Reflect on false negative tokens
echo ""
...
# Step 3: Reflect on boundary tokens with single-token FP filtering
echo ""
