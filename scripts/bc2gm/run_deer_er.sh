...
# bash scripts/bc2gm/run_deer_er.sh 8 deer openai text-embedding-3-small togetherai Qwen/Qwen2.5-7B-Instruct-Turbo 64 1.0 0.5 0.01 1 0.5 0.5 0.9
# bash scripts/bc2gm/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-mini-2024-07-18 64 1.0 0.5 0.01 1 0.5 0.5 0.9
# bash scripts/bc2gm/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-2024-08-06 64 1.0 0.5 0.01 1 0.5 0.5 0.9
