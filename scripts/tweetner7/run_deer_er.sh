...
# bash scripts/tweetner7/run_deer_er.sh 8 deer openai text-embedding-3-small togetherai Qwen/Qwen2.5-7B-Instruct-Turbo 64 1.0 1.0 0.01 1 0.75 0.75 0.95
# bash scripts/tweetner7/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-mini-2024-07-18 64 1.0 1.0 0.01 1 0.75 0.75 0.95
# bash scripts/tweetner7/run_deer_er.sh 8 deer openai text-embedding-3-small openai gpt-4o-2024-08-06 64 1.0 1.0 0.01 1 0.75 0.75 0.95
